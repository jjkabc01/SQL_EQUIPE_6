...
insert into TP2_RAPPORT ( NO_RAPPORT, NO_PROJET, TITRE_RAP, NOM_FICHIER_RAP, DATE_DEPOT_RAP, CODE_ETAT_RAP)
    values ( NO_RAPPORT_SEQ.nextval, 1003, 'RAPPORT_Accord_parfait', '/fichierAcord.docx', to_date('22-10-01','RR-MM-DD'), 'ABCD');
    
    
insert into TP2_RAPPORT ( NO_RAPPORT, NO_PROJET, TITRE_RAP, NOM_FICHIER_RAP, DATE_DEPOT_RAP, CODE_ETAT_RAP)
    values ( NO_RAPPORT_SEQ.nextval, 1004, 'RAPPORT_Accord_imparfait', '/fichierAcord.docx', to_date('21-01-01','RR-MM-DD'), 'ABCE');
